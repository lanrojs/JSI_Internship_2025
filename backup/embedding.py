...
def main():
    ...
    ap.add_argument("--size", type=int, default=500, help="Max tokens per chunk (BGE tokenizer)")
    ap.add_argument("--overlap", type=int, default=100, help="Token overlap between chunks (BGE tokenizer)")
